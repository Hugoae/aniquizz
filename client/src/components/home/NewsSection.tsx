...
import { allNews, typeConfig } from '@/data/newsData'; // Import des données partagées
...
export function NewsSection() {
  ...
  // On prend juste la dernière news pour l'accueil
  const latestNews = allNews.slice(0, 2);

  return (
    <section className="px-4 pb-6 pt-6"> {/* pt-6 pour un peu plus d'espace au dessus */}
      {/* Changement ici: max-w-xl pour élargir la section */}
      <div className="max-w-xl mx-auto"> 
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            <div className="p-1.5 rounded-lg bg-primary/20">
              {/* On récupère l'icône Update par défaut ou autre */}
