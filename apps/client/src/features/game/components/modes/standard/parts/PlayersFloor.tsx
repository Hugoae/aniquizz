      ...
      {hiddenCount > 0 && (
        <div className="mt-6 flex justify-center">
          <button
            ...
            className="flex items-center gap-2 rounded-full border border-border/60 bg-card/60 px-3 py-1.5 text-xs font-semibold text-muted-foreground shadow-sm backdrop-blur-md transition-colors hover:border-primary/40 hover:text-primary"
          >
