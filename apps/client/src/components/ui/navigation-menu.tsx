...
const navigationMenuTriggerStyle = cva(
  // MODIFICATION: rounded-md -> rounded-lg (Standard Interactif)
...
>(({ className, ...props }, ref) => (
  <div className={cn("absolute left-0 top-full flex justify-center")}>
    <NavigationMenuPrimitive.Viewport
      className={cn(
        // MODIFICATION: rounded-md -> rounded-xl (Overlay/Conteneur)
...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Indicator
    ...
    {...props}
  >
    {/* MODIFICATION: rounded-tl-sm -> rounded-tl-md */}
    <div className="relative top-[60%] h-2 w-2 rotate-45 rounded-tl-md bg-border shadow-md" />
  </NavigationMenuPrimitive.Indicator>
));
