  ...
  return (
    ...
    >
      <Button
        ...
        size="icon"
        onClick={onToggle}
        // ✅ rounded-lg pour le toggle sidebar (Layer 2)
        className="absolute -left-3 top-4 h-6 w-6 rounded-lg bg-card border border-border z-10 hover:bg-secondary"
      >
      ...
      {!isCollapsed && (
        <>
          <div className="p-2 border-b border-border">
            {/* ✅ rounded-lg pour le conteneur des onglets */}
            <div className="flex gap-1 bg-secondary/50 rounded-lg p-1">
              ...
              <Button
                ...
                className="flex-1 gap-2 relative rounded-md"
              >
                ...
                {messages.map((msg, index) => {
                    ...
                    return (
                        <div key={msg.id || index} className={cn("text-sm flex flex-col", isMe ? "items-end" : "items-start")}>
                            ...
                            {/* ✅ rounded-lg pour les bulles de chat */}
                            <div className={cn(
