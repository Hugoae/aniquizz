...
export function LibraryHero({ meta }: LibraryHeroProps) {
  return (
    <section className="relative overflow-hidden rounded-2xl border border-border/60 bg-card/40 p-4 sm:p-6 md:p-10">
      <div
      ...
      <Music2
        className="pointer-events-none absolute bottom-4 right-4 hidden h-24 w-24 text-primary/5 md:block md:h-32 md:w-32"
        aria-hidden="true"
      />
    </section>
  );
