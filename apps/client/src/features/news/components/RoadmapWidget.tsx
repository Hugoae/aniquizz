  ...
  return (
    <div className="sticky top-24 space-y-6">
        <div className="flex items-center gap-3 mb-2">
            {/* MODIFICATION: rounded-xl -> rounded-lg */}
        ...
        <div className="glass-card p-6 rounded-xl border border-white/5 bg-secondary/10 relative overflow-hidden">
            {/* Trait vertical */}
                ...
                {roadmapData.map((item, index) => {
                    ...
                    return (
                        <div key={index} className="flex gap-4 relative">
                            {/* Les points de timeline restent rounded-full (géométrie) */}
                            <div className={cn(
                            ...
                            <div className="pt-0.5 pb-2">
                                <div className="flex items-center gap-2 mb-1">
                                    ...
                                    {item.status === 'in-progress' && (
                                        // MODIFICATION: Ajout de rounded-md sur le badge
                                        <Badge className="text-[9px] px-1 py-0 h-4 bg-purple-500/20 text-purple-400 border-0 rounded-md">En cours</Badge>
                                    )}
                                </div>
