...
export function TriviaCard() {
    ...
    return (
        <div className="w-full max-w-4xl mx-auto mt-20 animate-fade-in px-4">
            {/* MODIFICATION: rounded-3xl -> rounded-xl */}
            <div className="glass-card relative overflow-hidden rounded-xl border border-white/10 bg-gradient-to-br from-indigo-500/10 via-purple-500/5 to-background shadow-2xl">
                ...
                <div className="flex flex-col md:flex-row items-center p-6 md:p-8 gap-6 relative z-10">
                    ...
                    {/* Icône */}
                    {/* MODIFICATION: rounded-2xl -> rounded-lg */}
                    <div className="shrink-0 p-4 bg-white/5 rounded-lg border border-white/10 shadow-inner">
